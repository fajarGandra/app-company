...
@section('content')
    ...
    <section class="banner-section style-two">
      <div class="swiper-container banner-slider">
          <div class="swiper-wrapper">
              <!-- Slide Item -->
              <div class="swiper-slide" style="background-image: url(frontend/assets/images/main-slider/image-4.jpg);">
              ...
              <!-- Slide Item -->
              <div class="swiper-slide" style="background-image: url(frontend/assets/images/main-slider/image-5.jpg);">
                  <div class="content-outer">
                      <div class="content-box">
                          <div class="inner">
              ...
              <!-- Slide Item -->
              <div class="swiper-slide" style="background-image: url(frontend/assets/images/main-slider/image-6.jpg);">
                  <div class="content-outer">
                      <div class="content-box">
                          <div class="inner">
                  ...
                  <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "480" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "3" }, "1200":{ "items" : "3" }}}'>
                      <div class="col-lg-12 service-block-two">
                          <div class="inner-box">
                              <div class="icon">
                                  ...
                                  <div class="shape"><img src="{{ asset('frontend/assets/images/shape/shape-6.png') }}" alt=""></div>
                              </div>
                              <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-36.jpg') }}" alt=""></div>
                      ...
                      <div class="col-lg-12 service-block-two">
                          <div class="inner-box">
                              ...
                              <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-37.jpg') }}" alt=""></div>
                              <div class="lower-content">      
                                  <h5>Cutting</h5>                      
                                  <h4>Laser & Plasma</h4>
                              </div>
                      ...
                      <div class="col-lg-12 service-block-two">
                          <div class="inner-box">
                              ...
                              <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-38.jpg') }}" alt=""></div>
                              <div class="lower-content">       
                                  <h5>Welding</h5>                     
  ...
  <section class="about-section-two">
      <div class="auto-container">
          <div class="row">
              <div class="col-lg-6">
                  <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-22.jpg') }}" alt=""></div>
              </div>
              <div class="col-lg-6">
          ...
          <div class="row">
              <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "480" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "3" }, "1200":{ "items" : "3" }}}'>
                  <div class="col-lg-12 team-block-two">
                      <div class="inner-box">
                          <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-7.jpg') }}" alt=""></div>
                  ...
                  <div class="col-lg-12 team-block-two">
                      <div class="inner-box">
                          <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-8.jpg') }}" alt=""></div>
                          <div class="designation">Founder & CEO</div>
                          <div class="overlay">
                              <div>
                                  <h4>Boris Evan</h4>
                  ...
                  <div class="col-lg-12 team-block-two">
                      <div class="inner-box">
                          <div class="image"><img src="{{ asset('frontend/assets/images/resource/image-9.jpg') }}" alt=""></div>
                          <div class="designation">Founder & CEO</div>
                          <div class="overlay">
                              <div>
                                  <h4>Boris Evan</h4>
              ...
              <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "1" } , "992":{ "items" : "2" }, "1200":{ "items" : "2" }}}'>
                  <div class="col-lg-12 testimonial-block-two">
                      <div class="inner-box">
                          ...
                          <div class="image"><div class="image-wrapper"><img src="{{ asset('frontend/assets/images/resource/author-4.jpg') }}" alt=""></div></div>
                          <h4>Lillian Grace</h4>
                  ...
                  <div class="col-lg-12 testimonial-block-two">
                      <div class="inner-box">
                          ...
                          <div class="image"><div class="image-wrapper"><img src="{{ asset('frontend/assets/images/resource/author-5.jpg') }}" alt=""></div></div>
                          <h4>Nathan Felix</h4>
  ...
  <section class="contact-form-section style-two" style="background-image: url(frontend/assets/images/background/bg-6.jpg);">
      <div class="auto-container">
          <div class="sec-title text-center">
              ...
              <div class="col-lg-8">
                  <div class="wrapper-box">                        
                      ...
                      <div class="contact-form">
                          <form method="post" action="{{ asset('frontend/assets/inc/sendmail.php') }}" id="contact-form">
                              <div class="row">
                                  <div class="col-md-6">
          ...
          <div class="row">
              <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "3" }, "1200":{ "items" : "3" }}}'>
                  <div class="col-lg-12 news-block">
                      <div class="inner-box">
                          <div class="image">
                              <img src="{{ asset('frontend/assets/images/resource/image-31.jpg') }}" alt="">
                              <div class="overlay-two">
                                  <a href="{{ asset('frontend/assets/images/resource/image-31.jpg') }}" class="lightbox-image" data-fancybox="gallery"><span class="flaticon-zoom-in"></span></a>
                  ...
                  <div class="col-lg-12 news-block">
                      <div class="inner-box">
                          <div class="image">
                              <img src="{{ asset('frontend/assets/images/resource/image-32.jpg') }}" alt="">
                              <div class="overlay-two">
                                  <a href="{{ asset('frontend/assets/images/resource/image-32.jpg') }}" class="lightbox-image" data-fancybox="gallery"><span class="flaticon-zoom-in"></span></a>
                                  <a href="blog-details.html"><span class="flaticon-link"></span></a>
                              </div>
                          </div>
                          <div class="lower-content">
                  ...
                  <div class="col-lg-12 news-block">
                      <div class="inner-box">
                          <div class="image">
                              <img src="{{ asset('frontend/assets/images/resource/image-33.jpg') }}" alt="">
                              <div class="overlay-two">
                                  <a href="{{ asset('frontend/assets/images/resource/image-33.jpg') }}" class="lightbox-image" data-fancybox="gallery"><span class="flaticon-zoom-in"></span></a>
                                  <a href="blog-details.html"><span class="flaticon-link"></span></a>
                              </div>
                          </div>
                          <div class="lower-content">
